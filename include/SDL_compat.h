...
extern DECLSPEC void SDLCALL SDL_BlitRects(SDL_Surface * screen, int numrects, SDL_Rect * rects);
extern DECLSPEC void SDLCALL SDL_BlitToScreen(SDL_Surface * surface, int numrects, SDL_Rect * src, SDL_Rect* dst);
extern DECLSPEC void SDLCALL SDL_FlipRects(int numrects, SDL_Rect * rects);
